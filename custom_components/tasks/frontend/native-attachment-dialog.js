...
export const ATTACHMENT_DIALOG_TAG="tasks-attachment-dialog";
...
export class TasksAttachmentDialog extends HTMLElement {
...
if(!customElements.get(ATTACHMENT_DIALOG_TAG))customElements.define(ATTACHMENT_DIALOG_TAG,TasksAttachmentDialog);
