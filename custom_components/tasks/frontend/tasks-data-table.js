...
export class TasksDataTable extends HTMLElement {
  ...
  render(){
    ...
    this.shadowRoot.innerHTML=`<style>
      :host{display:flex;position:relative;height:100%;min-height:0;flex-direction:column;container-type:inline-size;background:var(--primary-background-color);color:var(--primary-text-color)}
      .toolbar{position:sticky;z-index:5;top:0;box-sizing:border-box;height:calc(var(--header-height,0px) + var(--safe-area-inset-top,0px));flex:0 0 auto;padding-block-start:var(--safe-area-inset-top);padding-inline-end:var(--safe-area-inset-right);border-bottom:1px solid var(--divider-color);background:var(--sidebar-background-color);font-size:var(--ha-font-size-xl);font-weight:var(--ha-font-weight-normal)}
      ...
      @container (max-width:600px){.toolbar{padding-inline-start:var(--safe-area-inset-left)}.toolbar-content{padding:var(--ha-space-1)}ha-menu-button{margin-inline-end:0}.main-title{margin-inline-start:var(--main-title-margin,var(--ha-space-2))}.search{min-width:0}.selection{padding-inline:var(--ha-space-2)}.table-wrap table,.table-wrap thead,.table-wrap tbody{display:block}.table-wrap thead tr{display:flex}.table-wrap thead th{display:none}.table-wrap thead th:first-child,.table-wrap thead th[data-column="icon"],.table-wrap thead th[data-column="name"]{display:flex;align-items:center}.table-wrap thead th:first-child{flex:0 0 calc(var(--ha-space-6) * 2)}.table-wrap thead th[data-column="icon"]{flex:0 0 calc(var(--ha-space-6) * 2)}.table-wrap thead th[data-column="name"]{min-width:0;flex:1;padding-inline:var(--ha-space-2)}tbody tr.task-row{display:flex;height:auto;min-height:var(--data-table-row-height,52px)}tbody tr.task-row td{display:none;padding-inline:var(--ha-space-2)}tbody tr.task-row td:first-child,tbody tr.task-row td[data-column="icon"],tbody tr.task-row td[data-column="name"],tbody tr.task-row td[data-column="actions"]{display:flex;align-items:center}tbody tr.task-row td:first-child{flex:0 0 calc(var(--ha-space-6) * 2);padding-inline-start:var(--ha-space-4);padding-inline-end:0}tbody tr.task-row td[data-column="icon"]{flex:0 0 calc(var(--ha-space-6) * 2)}tbody tr.task-row td[data-column="name"]{min-width:0;flex:1}.mobile-details{display:block}tbody tr.group-row,tbody tr.empty-row{display:table;width:100%}}
    </style>
    <div class="toolbar">
