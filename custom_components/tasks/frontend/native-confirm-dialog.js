...
export const CONFIRM_DIALOG_TAG="tasks-confirm-dialog";
...
export class TasksConfirmDialog extends HTMLElement {
...
if(!customElements.get(CONFIRM_DIALOG_TAG))customElements.define(CONFIRM_DIALOG_TAG,TasksConfirmDialog);
