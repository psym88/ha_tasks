var se=globalThis,ae=se.ShadowRoot&&(se.ShadyCSS===void 0||se.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,xe=Symbol(),nt=new WeakMap,W=class{constructor(e,t,i){if(this._$cssResult$=!0,i!==xe)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=t}get styleSheet(){let e=this.o,t=this.t;if(ae&&e===void 0){let i=t!==void 0&&t.length===1;i&&(e=nt.get(t)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),i&&nt.set(t,e))}return e}toString(){return this.cssText}},lt=a=>new W(typeof a=="string"?a:a+"",void 0,xe),b=(a,...e)=>{let t=a.length===1?a[0]:e.reduce((i,s,o)=>i+(l=>{if(l._$cssResult$===!0)return l.cssText;if(typeof l=="number")return l;throw Error("Value passed to 'css' function must be a 'css' function result: "+l+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(s)+a[o+1],a[0]);return new W(t,a,xe)},ct=(a,e)=>{if(ae)a.adoptedStyleSheets=e.map(t=>t instanceof CSSStyleSheet?t:t.styleSheet);else for(let t of e){let i=document.createElement("style"),s=se.litNonce;s!==void 0&&i.setAttribute("nonce",s),i.textContent=t.cssText,a.appendChild(i)}},Ee=ae?a=>a:a=>a instanceof CSSStyleSheet?(e=>{let t="";for(let i of e.cssRules)t+=i.cssText;return lt(t)})(a):a;var{is:ri,defineProperty:oi,getOwnPropertyDescriptor:ni,getOwnPropertyNames:li,getOwnPropertySymbols:ci,getPrototypeOf:di}=Object,re=globalThis,dt=re.trustedTypes,hi=dt?dt.emptyScript:"",ui=re.reactiveElementPolyfillSupport,G=(a,e)=>a,Ae={toAttribute(a,e){switch(e){case Boolean:a=a?hi:null;break;case Object:case Array:a=a==null?a:JSON.stringify(a)}return a},fromAttribute(a,e){let t=a;switch(e){case Boolean:t=a!==null;break;case Number:t=a===null?null:Number(a);break;case Object:case Array:try{t=JSON.parse(a)}catch{t=null}}return t}},ut=(a,e)=>!ri(a,e),ht={attribute:!0,type:String,converter:Ae,reflect:!1,useDefault:!1,hasChanged:ut};Symbol.metadata??=Symbol("metadata"),re.litPropertyMetadata??=new WeakMap;var S=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??=[]).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,t=ht){if(t.state&&(t.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((t=Object.create(t)).wrapped=!0),this.elementProperties.set(e,t),!t.noAccessor){let i=Symbol(),s=this.getPropertyDescriptor(e,i,t);s!==void 0&&oi(this.prototype,e,s)}}static getPropertyDescriptor(e,t,i){let{get:s,set:o}=ni(this.prototype,e)??{get(){return this[t]},set(l){this[t]=l}};return{get:s,set(l){let p=s?.call(this);o?.call(this,l),this.requestUpdate(e,p,i)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??ht}static _$Ei(){if(this.hasOwnProperty(G("elementProperties")))return;let e=di(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(G("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(G("properties"))){let t=this.properties,i=[...li(t),...ci(t)];for(let s of i)this.createProperty(s,t[s])}let e=this[Symbol.metadata];if(e!==null){let t=litPropertyMetadata.get(e);if(t!==void 0)for(let[i,s]of t)this.elementProperties.set(i,s)}this._$Eh=new Map;for(let[t,i]of this.elementProperties){let s=this._$Eu(t,i);s!==void 0&&this._$Eh.set(s,t)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){let t=[];if(Array.isArray(e)){let i=new Set(e.flat(1/0).reverse());for(let s of i)t.unshift(Ee(s))}else e!==void 0&&t.push(Ee(e));return t}static _$Eu(e,t){let i=t.attribute;return i===!1?void 0:typeof i=="string"?i:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){this._$ES=new Promise(e=>this.enableUpdating=e),this._$AL=new Map,this._$E_(),this.requestUpdate(),this.constructor.l?.forEach(e=>e(this))}addController(e){(this._$EO??=new Set).add(e),this.renderRoot!==void 0&&this.isConnected&&e.hostConnected?.()}removeController(e){this._$EO?.delete(e)}_$E_(){let e=new Map,t=this.constructor.elementProperties;for(let i of t.keys())this.hasOwnProperty(i)&&(e.set(i,this[i]),delete this[i]);e.size>0&&(this._$Ep=e)}createRenderRoot(){let e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return ct(e,this.constructor.elementStyles),e}connectedCallback(){this.renderRoot??=this.createRenderRoot(),this.enableUpdating(!0),this._$EO?.forEach(e=>e.hostConnected?.())}enableUpdating(e){}disconnectedCallback(){this._$EO?.forEach(e=>e.hostDisconnected?.())}attributeChangedCallback(e,t,i){this._$AK(e,i)}_$ET(e,t){let i=this.constructor.elementProperties.get(e),s=this.constructor._$Eu(e,i);if(s!==void 0&&i.reflect===!0){let o=(i.converter?.toAttribute!==void 0?i.converter:Ae).toAttribute(t,i.type);this._$Em=e,o==null?this.removeAttribute(s):this.setAttribute(s,o),this._$Em=null}}_$AK(e,t){let i=this.constructor,s=i._$Eh.get(e);if(s!==void 0&&this._$Em!==s){let o=i.getPropertyOptions(s),l=typeof o.converter=="function"?{fromAttribute:o.converter}:o.converter?.fromAttribute!==void 0?o.converter:Ae;this._$Em=s;let p=l.fromAttribute(t,o.type);this[s]=p??this._$Ej?.get(s)??p,this._$Em=null}}requestUpdate(e,t,i,s=!1,o){if(e!==void 0){let l=this.constructor;if(s===!1&&(o=this[e]),i??=l.getPropertyOptions(e),!((i.hasChanged??ut)(o,t)||i.useDefault&&i.reflect&&o===this._$Ej?.get(e)&&!this.hasAttribute(l._$Eu(e,i))))return;this.C(e,t,i)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,t,{useDefault:i,reflect:s,wrapped:o},l){i&&!(this._$Ej??=new Map).has(e)&&(this._$Ej.set(e,l??t??this[e]),o!==!0||l!==void 0)||(this._$AL.has(e)||(this.hasUpdated||i||(t=void 0),this._$AL.set(e,t)),s===!0&&this._$Em!==e&&(this._$Eq??=new Set).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(t){Promise.reject(t)}let e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??=this.createRenderRoot(),this._$Ep){for(let[s,o]of this._$Ep)this[s]=o;this._$Ep=void 0}let i=this.constructor.elementProperties;if(i.size>0)for(let[s,o]of i){let{wrapped:l}=o,p=this[s];l!==!0||this._$AL.has(s)||p===void 0||this.C(s,void 0,o,p)}}let e=!1,t=this._$AL;try{e=this.shouldUpdate(t),e?(this.willUpdate(t),this._$EO?.forEach(i=>i.hostUpdate?.()),this.update(t)):this._$EM()}catch(i){throw e=!1,this._$EM(),i}e&&this._$AE(t)}willUpdate(e){}_$AE(e){this._$EO?.forEach(t=>t.hostUpdated?.()),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&=this._$Eq.forEach(t=>this._$ET(t,this[t])),this._$EM()}updated(e){}firstUpdated(e){}};S.elementStyles=[],S.shadowRootOptions={mode:"open"},S[G("elementProperties")]=new Map,S[G("finalized")]=new Map,ui?.({ReactiveElement:S}),(re.reactiveElementVersions??=[]).push("2.1.2");var Fe=globalThis,pt=a=>a,oe=Fe.trustedTypes,mt=oe?oe.createPolicy("lit-html",{createHTML:a=>a}):void 0,$t="$lit$",P=`lit$${Math.random().toFixed(9).slice(2)}$`,kt="?"+P,pi=`<${kt}>`,H=document,J=()=>H.createComment(""),Q=a=>a===null||typeof a!="object"&&typeof a!="function",He=Array.isArray,mi=a=>He(a)||typeof a?.[Symbol.iterator]=="function",Ce=`[ 	
\f\r]`,Z=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,gt=/-->/g,ft=/>/g,L=RegExp(`>|${Ce}(?:([^\\s"'>=/]+)(${Ce}*=${Ce}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),bt=/'/g,vt=/"/g,_t=/^(?:script|style|textarea|title)$/i,Me=a=>(e,...t)=>({_$litType$:a,strings:e,values:t}),n=Me(1),wt=Me(2),Tt=Me(3),M=Symbol.for("lit-noChange"),c=Symbol.for("lit-nothing"),yt=new WeakMap,F=H.createTreeWalker(H,129);function xt(a,e){if(!He(a)||!a.hasOwnProperty("raw"))throw Error("invalid template strings array");return mt!==void 0?mt.createHTML(e):e}var gi=(a,e)=>{let t=a.length-1,i=[],s,o=e===2?"<svg>":e===3?"<math>":"",l=Z;for(let p=0;p<t;p++){let h=a[p],u,d,m=-1,w=0;for(;w<h.length&&(l.lastIndex=w,d=l.exec(h),d!==null);)w=l.lastIndex,l===Z?d[1]==="!--"?l=gt:d[1]!==void 0?l=ft:d[2]!==void 0?(_t.test(d[2])&&(s=RegExp("</"+d[2],"g")),l=L):d[3]!==void 0&&(l=L):l===L?d[0]===">"?(l=s??Z,m=-1):d[1]===void 0?m=-2:(m=l.lastIndex-d[2].length,u=d[1],l=d[3]===void 0?L:d[3]==='"'?vt:bt):l===vt||l===bt?l=L:l===gt||l===ft?l=Z:(l=L,s=void 0);let T=l===L&&a[p+1].startsWith("/>")?" ":"";o+=l===Z?h+pi:m>=0?(i.push(u),h.slice(0,m)+$t+h.slice(m)+P+T):h+P+(m===-2?p:T)}return[xt(a,o+(a[t]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),i]},X=class a{constructor({strings:e,_$litType$:t},i){let s;this.parts=[];let o=0,l=0,p=e.length-1,h=this.parts,[u,d]=gi(e,t);if(this.el=a.createElement(u,i),F.currentNode=this.el.content,t===2||t===3){let m=this.el.content.firstChild;m.replaceWith(...m.childNodes)}for(;(s=F.nextNode())!==null&&h.length<p;){if(s.nodeType===1){if(s.hasAttributes())for(let m of s.getAttributeNames())if(m.endsWith($t)){let w=d[l++],T=s.getAttribute(m).split(P),R=/([.?@])?(.*)/.exec(w);h.push({type:1,index:o,name:R[2],strings:T,ctor:R[1]==="."?Pe:R[1]==="?"?De:R[1]==="@"?Ie:z}),s.removeAttribute(m)}else m.startsWith(P)&&(h.push({type:6,index:o}),s.removeAttribute(m));if(_t.test(s.tagName)){let m=s.textContent.split(P),w=m.length-1;if(w>0){s.textContent=oe?oe.emptyScript:"";for(let T=0;T<w;T++)s.append(m[T],J()),F.nextNode(),h.push({type:2,index:++o});s.append(m[w],J())}}}else if(s.nodeType===8)if(s.data===kt)h.push({type:2,index:o});else{let m=-1;for(;(m=s.data.indexOf(P,m+1))!==-1;)h.push({type:7,index:o}),m+=P.length-1}o++}}static createElement(e,t){let i=H.createElement("template");return i.innerHTML=e,i}};function U(a,e,t=a,i){if(e===M)return e;let s=i!==void 0?t._$Co?.[i]:t._$Cl,o=Q(e)?void 0:e._$litDirective$;return s?.constructor!==o&&(s?._$AO?.(!1),o===void 0?s=void 0:(s=new o(a),s._$AT(a,t,i)),i!==void 0?(t._$Co??=[])[i]=s:t._$Cl=s),s!==void 0&&(e=U(a,s._$AS(a,e.values),s,i)),e}var Se=class{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){let{el:{content:t},parts:i}=this._$AD,s=(e?.creationScope??H).importNode(t,!0);F.currentNode=s;let o=F.nextNode(),l=0,p=0,h=i[0];for(;h!==void 0;){if(l===h.index){let u;h.type===2?u=new Y(o,o.nextSibling,this,e):h.type===1?u=new h.ctor(o,h.name,h.strings,this,e):h.type===6&&(u=new Le(o,this,e)),this._$AV.push(u),h=i[++p]}l!==h?.index&&(o=F.nextNode(),l++)}return F.currentNode=H,s}p(e){let t=0;for(let i of this._$AV)i!==void 0&&(i.strings!==void 0?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}},Y=class a{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(e,t,i,s){this.type=2,this._$AH=c,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=s,this._$Cv=s?.isConnected??!0}get parentNode(){let e=this._$AA.parentNode,t=this._$AM;return t!==void 0&&e?.nodeType===11&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=U(this,e,t),Q(e)?e===c||e==null||e===""?(this._$AH!==c&&this._$AR(),this._$AH=c):e!==this._$AH&&e!==M&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):mi(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==c&&Q(this._$AH)?this._$AA.nextSibling.data=e:this.T(H.createTextNode(e)),this._$AH=e}$(e){let{values:t,_$litType$:i}=e,s=typeof i=="number"?this._$AC(e):(i.el===void 0&&(i.el=X.createElement(xt(i.h,i.h[0]),this.options)),i);if(this._$AH?._$AD===s)this._$AH.p(t);else{let o=new Se(s,this),l=o.u(this.options);o.p(t),this.T(l),this._$AH=o}}_$AC(e){let t=yt.get(e.strings);return t===void 0&&yt.set(e.strings,t=new X(e)),t}k(e){He(this._$AH)||(this._$AH=[],this._$AR());let t=this._$AH,i,s=0;for(let o of e)s===t.length?t.push(i=new a(this.O(J()),this.O(J()),this,this.options)):i=t[s],i._$AI(o),s++;s<t.length&&(this._$AR(i&&i._$AB.nextSibling,s),t.length=s)}_$AR(e=this._$AA.nextSibling,t){for(this._$AP?.(!1,!0,t);e!==this._$AB;){let i=pt(e).nextSibling;pt(e).remove(),e=i}}setConnected(e){this._$AM===void 0&&(this._$Cv=e,this._$AP?.(e))}},z=class{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,t,i,s,o){this.type=1,this._$AH=c,this._$AN=void 0,this.element=e,this.name=t,this._$AM=s,this.options=o,i.length>2||i[0]!==""||i[1]!==""?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=c}_$AI(e,t=this,i,s){let o=this.strings,l=!1;if(o===void 0)e=U(this,e,t,0),l=!Q(e)||e!==this._$AH&&e!==M,l&&(this._$AH=e);else{let p=e,h,u;for(e=o[0],h=0;h<o.length-1;h++)u=U(this,p[i+h],t,h),u===M&&(u=this._$AH[h]),l||=!Q(u)||u!==this._$AH[h],u===c?e=c:e!==c&&(e+=(u??"")+o[h+1]),this._$AH[h]=u}l&&!s&&this.j(e)}j(e){e===c?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}},Pe=class extends z{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===c?void 0:e}},De=class extends z{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==c)}},Ie=class extends z{constructor(e,t,i,s,o){super(e,t,i,s,o),this.type=5}_$AI(e,t=this){if((e=U(this,e,t,0)??c)===M)return;let i=this._$AH,s=e===c&&i!==c||e.capture!==i.capture||e.once!==i.once||e.passive!==i.passive,o=e!==c&&(i===c||s);s&&this.element.removeEventListener(this.name,this,i),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,e):this._$AH.handleEvent(e)}},Le=class{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){U(this,e)}};var fi=Fe.litHtmlPolyfillSupport;fi?.(X,Y),(Fe.litHtmlVersions??=[]).push("3.3.3");var Et=(a,e,t)=>{let i=t?.renderBefore??e,s=i._$litPart$;if(s===void 0){let o=t?.renderBefore??null;i._$litPart$=s=new Y(e.insertBefore(J(),o),o,void 0,t??{})}return s._$AI(a),s};var Oe=globalThis,D=class extends S{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){let e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){let t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=Et(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return M}};D._$litElement$=!0,D.finalized=!0,Oe.litElementHydrateSupport?.({LitElement:D});var bi=Oe.litElementPolyfillSupport;bi?.({LitElement:D});(Oe.litElementVersions??=[]).push("4.2.2");var Ct=Symbol.for(""),vi=a=>{if(a?.r===Ct)return a?._$litStatic$},$=a=>({_$litStatic$:a,r:Ct});var At=new Map,Ne=a=>(e,...t)=>{let i=t.length,s,o,l=[],p=[],h,u=0,d=!1;for(;u<i;){for(h=e[u];u<i&&(o=t[u],(s=vi(o))!==void 0);)h+=s+e[++u],d=!0;u!==i&&p.push(o),l.push(h),u++}if(u===i&&l.push(e[i]),d){let m=l.join("$$lit$$");(e=At.get(m))===void 0&&(l.raw=l,At.set(m,e=l)),t=p}return a(e,...t)},g=Ne(n),Ji=Ne(wt),Qi=Ne(Tt);var St=(a,e)=>a.connection.subscribeMessage(e,{type:"tasks/subscribe"}),Pt=a=>{if(a.type==="sensor")return{type:a.type,condition_template:a.conditionTemplate.trim(),message_template:a.messageTemplate.trim()||null};let e={type:a.type,unit:a.unit,interval:a.interval};return a.type==="fixed"&&(e.time=a.time,a.unit==="weekly"?e.weekdays=a.weekdays:a.unit==="monthly"?e.day=a.day:a.unit==="yearly"&&(e.day=a.day,e.month=a.month)),e},yi=async(a,e)=>{let t=new FormData;t.append("file",e);let i=await a.fetchWithAuth("/api/tasks/upload",{method:"POST",body:t});if(!i.ok)throw new Error(`File upload failed (${i.status})`);return(await i.json()).file_id};var Dt=async(a,e,t)=>{let i=await Promise.all((t.files?.staged||[]).map(s=>yi(a,s)));return a.connection.sendMessagePromise({type:"tasks/task/save",...e?{task_id:e.id}:{},name:t.name.trim(),description:t.description.trim()||null,icon:t.icon.trim()||null,active:t.active,...t.schedule?{schedule:Pt(t.schedule)}:e?{schedule:e.schedule}:{},...t.assignment?{assignee_id:t.assignment.assigneeId||null,label_ids:t.assignment.labelIds,nfc_tag_id:t.assignment.nfcTagId||null}:{},...t.notification?{notification:{device_ids:t.notification.deviceIds,persistent:t.notification.persistent,critical:t.notification.critical,route:t.notification.route.trim()||null}}:{},file_ids:i,deleted_attachment_ids:t.files?.deletedAttachmentIds||[],deleted_history_entry_ids:t.files?.deletedHistoryEntryIds||[]})},B=async a=>{let[e,t,i]=await Promise.all([a.connection.sendMessagePromise({type:"tasks/list"}),a.connection.sendMessagePromise({type:"tag/list"}).catch(()=>[]),a.connection.sendMessagePromise({type:"config/label_registry/list"}).catch(()=>[])]);return{users:e.users||[],tags:Array.isArray(t)?t:[],labels:Array.isArray(i)?i:[]}},ne=async a=>{let e=await a.connection.sendMessagePromise({type:"config/device_registry/list"});return(Array.isArray(e)?e:[]).filter(t=>t.identifiers?.some(i=>i?.[0]==="mobile_app"))},It=(a,e)=>a.connection.sendMessagePromise({type:"tasks/task/bulk",operations:e}),Lt=(a,e)=>a.connection.sendMessagePromise({type:"tasks/attachment/urls",task_id:e}),Ft=(a,e,t)=>a.connection.sendMessagePromise({type:"tasks/task/complete",task_id:e,notes:t.trim()||null}),Ht=(a,e)=>a.connection.sendMessagePromise({type:"tasks/task/delete",task_id:e}),Mt=(a,e,t)=>a.connection.sendMessagePromise({type:"tasks/task/update",task_id:e,active:t}),Ot=(a,e,t)=>a.connection.sendMessagePromise({type:"tasks/task/preview_next_due",schedule:Pt(e),...t?{due:t}:{}});var Nt=new URL(import.meta.url).pathname.match(/\/tasks_frontend\/([^/]+)\//)?.[1],$i=Nt?`?v=${encodeURIComponent(decodeURIComponent(Nt))}`:"",Bt={},Rt="",Ut="",Re=new Map,Ue=new Set,ki=a=>{let e=String(a||"en").toLowerCase().split(/[-_]/)[0];return/^[a-z]{2,3}$/.test(e)?e:"en"},_i=a=>Object.fromEntries(Object.entries(a.common||{}).filter(([e])=>e.startsWith("ui_")).map(([e,t])=>{let i=e.indexOf("_",3);return[`${e.slice(3,i)}.${e.slice(i+1)}`,t]})),zt=a=>{if(!Re.has(a)){let e=a==="en"?"/tasks_strings.json":`/tasks_translations/${a}.json`;Re.set(a,fetch(`${e}${$i}`).then(async t=>t.ok?t.json():{}).then(_i).catch(()=>({})))}return Re.get(a)},r=(a,e={})=>String(Bt[a]??a).replace(/\{(\w+)\}/g,(t,i)=>String(e[i]??`{${i}}`)),ee=(a,e)=>r("schedule.with_time",{description:a,time:r("app.at_time",{time:e})}),le=a=>{if(typeof a!="string"||!a)return;let e=`error.${a}`,t=r(e);return t===e?void 0:t},E=a=>{if(a&&typeof a=="object"){let e=a,t=le(e.code);if(t)return t;let i=le(e.message);if(i)return i;if(typeof e.message=="string"&&e.message)return e.message}return a instanceof Error?le(a.message)||a.message:typeof a=="string"&&a?le(a)||a:r("error.unknown")};async function ze(a){let e=ki(a);Ut=e;let t=await zt("en"),i=e==="en"?t:await zt(e);if(Ut===e&&Rt!==e){Rt=e,Bt={...t,...i};for(let s of Ue)s()}}var Vt=a=>(Ue.add(a),()=>Ue.delete(a)),jt=ze(globalThis.navigator?.language);var f=class extends D{unsubscribeLanguage;connectedCallback(){this.unsubscribeLanguage?.(),this.unsubscribeLanguage=Vt(()=>this.requestUpdate()),super.connectedCallback()}disconnectedCallback(){this.unsubscribeLanguage?.(),this.unsubscribeLanguage=void 0,super.disconnectedCallback()}};var te=(a,e)=>{let t=e.toLowerCase(),i=a.split(".").pop()?.toLowerCase();return t.startsWith("image/")?"mdi:file-image-outline":t==="application/pdf"||i==="pdf"?"mdi:file-pdf-box":t.startsWith("text/")||["txt","md","log"].includes(i||"")?"mdi:file-document-outline":t.startsWith("audio/")?"mdi:file-music-outline":t.startsWith("video/")?"mdi:file-video-outline":t.includes("zip")||t.includes("compressed")||["zip","rar","7z","gz"].includes(i||"")?"mdi:folder-zip-outline":t.includes("spreadsheet")||t.includes("excel")||["csv","xls","xlsx","ods"].includes(i||"")?"mdi:file-table-outline":t.includes("word")||["doc","docx","odt","rtf"].includes(i||"")?"mdi:file-word-outline":"mdi:file-outline"},ie=a=>a<1024?`${a} B`:a<1048576?`${Math.round(a/1024)} KB`:`${(a/1048576).toFixed(1)} MB`;var ce=a=>[...a].sort((e,t)=>Date.parse(t.occurred_at)-Date.parse(e.occurred_at)),de=a=>a.type==="problem"?"mdi:alert-circle-outline":a.notes==="tasks.history.completed_via_nfc"?"mdi:nfc":a.user_id?"mdi:account-outline":"mdi:note-text-outline";var O=a=>r(a?"problem.detected":"problem.standby"),N=()=>r("problem.trigger_unavailable");var Kt={daily:"day",weekly:"week",monthly:"month",yearly:"year"},he=(a,e)=>{if(a.type==="sensor")return r("schedule.problem_sensor_description");let t=a.unit||"daily",i=Math.max(1,Number(a.interval)||1),s=r(`schedule.period_${Kt[t]}`),o=r(`schedule.period_${Kt[t]}s`);if(a.type==="sliding")return r(i===1?"schedule.after_completion_one":"schedule.after_completion_many",{schedule_interval:i,period:i===1?s:o});let l=a.time||"09:00";if(t==="weekly"){let p=Array.from({length:7},(d,m)=>new Intl.DateTimeFormat(e,{weekday:"long",timeZone:"UTC"}).format(new Date(Date.UTC(2024,0,m+1)))),h=(a.weekdays||[]).map(d=>p[d]).filter(Boolean),u=h.length>1?`${h.slice(0,-1).join(", ")} ${r("schedule.and")} ${h.at(-1)}`:h[0]||"";return ee(r(i===1?"schedule.weekly_one":"schedule.weekly_many",{schedule_interval:i,days:u?` ${r("schedule.on_days",{days:u})}`:""}),l)}if(t==="monthly"){let p=a.day==="last"?r("schedule.on_last_day"):r("schedule.on_day_number",{day:Number(a.day||1)});return ee(r(i===1?"schedule.monthly_one":"schedule.monthly_many",{schedule_interval:i,day:p}),l)}if(t==="yearly"){let p=new Intl.DateTimeFormat(e,{month:"long"}).format(new Date(2024,(a.month||1)-1,1)),h=a.day==="last"?r("schedule.on_last_day_of_month",{month:p}):r("schedule.on_day_of_month",{day:Number(a.day||1),month:p});return ee(r(i===1?"schedule.yearly_one":"schedule.yearly_many",{schedule_interval:i,day:h}),l)}return ee(r(i===1?"schedule.fixed_one":"schedule.fixed_many",{schedule_interval:i,period:i===1?s:o}),l)};var v=a=>`ha-tasks-${a}`,us=decodeURIComponent(new URL(import.meta.url).pathname.match(/\/tasks_frontend\/([^/]+)\//)?.[1]||"");var Be=class extends f{static properties={heading:{},content:{attribute:!1},actions:{attribute:!1},width:{},open:{type:Boolean}};running=!1;closeValue="";constructor(){super(),this.heading="",this.content=n``,this.actions=[],this.width="medium",this.open=!1}close(e=""){this.closeValue=e,this.open=!1}async run(e){if(!this.running){this.running=!0;try{await e.run?.()!==!1&&this.close(e.value)}finally{this.running=!1}}}render(){let e=this.actions.at(-1),t=this.actions.slice(0,-1);return n`
      <ha-adaptive-dialog
        width=${this.width}
        flexcontent
    ...
    `}},Ve=v("dialog");customElements.get(Ve)||customElements.define(Ve,Be);var x=({heading:a,content:e,actions:t=[],width:i="medium"})=>{let s=document.createElement(Ve);return s.heading=a,s.content=e,s.actions=t,s.width=i,(document.querySelector("home-assistant")?.shadowRoot||document.body).append(s),s.open=!0,new Promise(l=>{s.addEventListener("tasks-dialog-closed",p=>{s.remove(),l(p.detail)},{once:!0})})};var je=class extends f{static properties={heading:{},warning:{type:Boolean},open:{type:Boolean}};static styles=b`
    .expandable {
      overflow: hidden;
  ...
  `;constructor(){super(),this.heading="",this.warning=!1,this.open=!1}render(){return n`
    ...
    `}},V=v("expandable");customElements.get(V)||customElements.define(V,je);var wi=b`
  :host {
    display: block;
  }
...
`,j=class extends f{static properties={label:{},value:{},required:{type:Boolean},disabled:{type:Boolean},error:{}};static styles=wi;constructor(){super(),this.label="",this.value="",this.required=!1,this.disabled=!1,this.error=""}change(e){this.value=e,this.error="",this.dispatchEvent(new CustomEvent("value-changed",{bubbles:!0,composed:!0,detail:e}))}errorMessage(){return this.error?n`<span class="error" role="alert">${this.error}</span>`:null}},Ke=class extends j{static properties={...j.properties,placeholder:{},hideLabel:{attribute:"hide-label",type:Boolean},multiline:{type:Boolean},hasToolbar:{attribute:"has-toolbar",type:Boolean},inputType:{attribute:"input-type"},min:{type:Number}};constructor(){super(),this.placeholder="",this.hideLabel=!1,this.multiline=!1,this.hasToolbar=!1,this.inputType="text",this.min=void 0}render(){return n`
      <label>
      ...
      ${this.errorMessage()}
    `}},qe=class extends j{static properties={...j.properties,options:{attribute:!1}};constructor(){super(),this.options=[]}render(){return n`
      <label>
  ...
  `;hass;task;scheduleDirty=!1;assignmentDirty=!1;notificationDirty=!1;previewRequest=0;templateValidationRequest=0;templateValidationTimer;constructor(){super(),this.name="",this.description="",this.status="active",this.icon="",this.assigneeId="",this.labelIds=[],this.nfcTagId="",this.users=[],this.labels=[],this.tags=[],this.assignmentLoading=!1,this.assignmentError="",this.notificationDeviceIds=[],this.notificationPersistent=!1,this.notificationCritical=!1,this.notificationRoute="",this.devices=[],this.notificationLoading=!1,this.notificationError="",this.notificationRouteError="",this.attachments=[],this.stagedFiles=[],this.deletedAttachmentIds=[],this.history=[],this.deletedHistoryEntryIds=[],this.scheduleType="sliding",this.scheduleUnit="monthly",this.scheduleInterval=1,this.scheduleWeekdays=[],this.scheduleDay=1,this.scheduleMonth=1,this.scheduleTime="09:00",this.conditionTemplate="",this.messageTemplate="",this.conditionPreview="",this.messagePreview="",this.conditionTemplateError="",this.messageTemplateError="",this.preview=[],this.previewLoading=!1,this.previewError="",this.previewExpanded=!1,this.nameError="",this.scheduleError="",this.saveError="",this.saving=!1,this.fileDropActive=!1}configure(e,t,i=[]){let s=Ai(e,t.due),o=Number(s.year),l=Number(s.month),p=Number(s.day),h=(new Date(Date.UTC(o,l-1,p)).getUTCDay()+6)%7;this.hass=e,this.task=t,this.name=t.name,this.description=t.description||"",this.status=t.active===!1?"inactive":"active",this.icon=t.icon||"",this.assigneeId=t.assignee_id||"",this.labelIds=[...t.label_ids||[]],this.nfcTagId=t.nfc_tag_id||"",this.notificationDeviceIds=[...new Set((t.notification.device_ids||[]).filter(d=>typeof d=="string"))],this.notificationPersistent=!!t.notification.persistent,this.notificationCritical=!!t.notification.critical,this.notificationRoute=t.notification.route||"",this.attachments=[...t.attachments],this.stagedFiles=[],this.deletedAttachmentIds=[],this.history=ce(t.history||[]),this.deletedHistoryEntryIds=[],this.scheduleType=t.schedule.type,t.schedule.type==="sensor"?(this.scheduleUnit="monthly",this.scheduleInterval=1,this.scheduleWeekdays=[h],this.scheduleDay=p,this.scheduleMonth=l,this.scheduleTime=`${s.hour||"09"}:${s.minute||"00"}`,this.conditionTemplate=t.schedule.condition_template,this.messageTemplate=t.schedule.message_template||""):(this.scheduleUnit=t.schedule.unit,this.scheduleInterval=t.schedule.interval,this.scheduleWeekdays=t.schedule.type==="fixed"&&t.schedule.weekdays?.length?[...t.schedule.weekdays]:[h],this.scheduleDay=t.schedule.type==="fixed"&&t.schedule.day?t.schedule.day:p,this.scheduleMonth=t.schedule.type==="fixed"&&t.schedule.month?t.schedule.month:l,this.scheduleTime=t.schedule.type==="fixed"&&t.schedule.time||`${s.hour||"09"}:${s.minute||"00"}`,this.conditionTemplate="",this.messageTemplate="");let u=!t.id;this.scheduleDirty=u,this.assignmentDirty=u,this.notificationDirty=u,this.loadAssignments(),this.loadNotifications(),this.updateComplete.then(()=>this.loadPreview()),this.validateProblemTemplates()}conditionValue(){return this.conditionTemplate.trim()}async chooseProblemEntity(){if(!this.hass||this.saving)return;let e=xi(this.conditionTemplate),t=e,i=document.createElement("ha-form");i.hass=this.hass,i.data={problemSensor:e},i.schema=[{name:"problemSensor",required:!0,selector:{entity:{filter:{domain:"binary_sensor"}}}}],i.computeLabel=()=>r("task.binary_sensor"),i.addEventListener("value-changed",l=>{t=l.detail.value.problemSensor||""});let s=!!(this.conditionTemplate.trim()&&!e);await x({heading:r("task.select_problem_entity"),content:n`
    ...
    `}renderPreview(){if(this.scheduleType==="sensor")return c;if(this.previewLoading&&!this.preview.length)return n`<p class="hint" aria-live="polite">
      ...
      ${this.preview.length>4?n`
          ...
          `:c}
    `}renderPlanning(){if(this.scheduleType==="sensor"){let e=this.task?.schedule.type==="sensor"&&this.task.problem_warning&&this.conditionValue()===this.task.schedule.condition_template.trim(),t=e?N():this.conditionPreview;return g`
        <div class="planning">
          <${y}
              ...
              <ul class="records">
                ${this.attachments.map(e=>{let t=this.deletedAttachmentIds.includes(e.id);return n`
                    <li class="record ${t?"pending":""}">
                      <ha-icon
                        class="record-icon"
                        .icon=${te(e.filename,e.content_type)}
                      ></ha-icon>
    ...
    `}},Ge=v("task-form");customElements.get(Ge)||customElements.define(Ge,We);var pe=async(a,e,t=[])=>{let i=e||{id:"",name:"",active:!0,schedule:{type:"sliding",unit:"monthly",interval:1},notification:{device_ids:[],persistent:!1,critical:!1,route:null},due:null,history:[],attachments:[]},s=document.createElement(Ge);return s.configure(a,i,t),await x({heading:i.id?r("task.edit"):r("task.new"),content:s,actions:[{label:r("common.save"),value:"save",run:()=>s.save()}]})==="save"},Gt=(a,e)=>pe(a,{...e,id:"",nfc_tag_id:null,due:null,history:[],attachments:[],problem_warning:void 0});var Ze=class extends f{static properties={items:{attribute:!1},label:{},open:{state:!0}};static styles=b`
    :host {
      display: inline-flex;
    }
  ...
  `;registryConnection;closePanels=e=>{let t=e.composedPath();for(let i of this.renderRoot.querySelectorAll("details[open]"))t.includes(i)||i.removeAttribute("open");t.some(i=>i instanceof HTMLElement&&i.classList.contains("toolbar-popover"))||(this.openToolbarPanel="")};constructor(){super();let e=Xt("localStorage",Zt),t=Xt("sessionStorage",Jt);this.tasks=[],this.compact=!1,this.showBulkSelection=!0,this.showIcon=!0,this.showAddTask=!1,this.showHeader=!0,this.showFilters=!0,this.configuredFilters=void 0,this.showColumns=!0,this.configuredColumns=void 0,this.now=void 0,this.showSearch=!0,this.showActionMenu=!0,this.search=typeof t.search=="string"?t.search:"";let i=t.filters&&typeof t.filters=="object"&&!Array.isArray(t.filters)?t.filters:{};this.filters=Object.fromEntries(Object.keys(fe()).map(o=>[o,Array.isArray(i[o])?i[o].filter(l=>typeof l=="string"):[]])),this.openFilterGroups=[];let s=e.columns&&typeof e.columns=="object"&&!Array.isArray(e.columns)?e.columns:{};this.columns=Object.fromEntries(Object.keys(Je).map(o=>[o,typeof s[o]=="boolean"?s[o]:Je[o]])),this.users=[],this.labels=[],this.tags=[],this.devices=[],this.registryError="",this.selectedIds=[],this.bulkAction="",this.bulkTarget="",this.openBulkPicker="",this.openToolbarPanel="",this.bulkBusy=!1,this.bulkError=""}connectedCallback(){super.connectedCallback(),document.addEventListener("click",this.closePanels)}disconnectedCallback(){document.removeEventListener("click",this.closePanels),super.disconnectedCallback()}updated(){this.hass?.connection!==this.registryConnection&&this.loadRegistries()}async loadRegistries(){if(!this.hass)return;let e=this.hass,t=e.connection;this.registryConnection=t,this.registryError="";let[i,s]=await Promise.allSettled([B(e),ne(e)]);this.registryConnection===t&&(i.status==="fulfilled"&&(this.users=i.value.users,this.labels=i.value.labels,this.tags=i.value.tags),s.status==="fulfilled"&&(this.devices=s.value),(i.status==="rejected"||s.status==="rejected")&&(this.registryError=r("app.registry_load_error")))}trigger(e){return e.schedule.type==="sensor"?r("task.problem_sensor"):e.schedule.type==="fixed"?r("task.fixed"):r("task.sliding")}status(e){return e.active===!1?r("app.paused"):r("app.active")}problemSensorWarning(e){if(e.schedule.type!=="sensor"||!e.problem_warning)return c;let t=N();return n`
    ...
    `}async applyBulk(){if(!this.hass||this.bulkBusy||!this.bulkAction||this.bulkNeedsTarget()&&!this.bulkTarget)return;let e=this.bulkOperations();if(e.length){if(this.bulkAction==="complete"||this.bulkAction==="delete"){let t=this.bulkAction==="delete";if(await x({heading:t?r("bulk.delete_title"):r("bulk.complete_title"),content:n`<p>
          ${t?r("bulk.delete_confirm",{count:e.length}):r("bulk.complete_confirm",{count:e.length})}
        </p>`,actions:[{label:r("common.cancel"),value:"cancel"},{label:t?r("common.delete"):r("app.complete"),value:"confirm",destructive:t}]})!=="confirm")return}this.bulkBusy=!0,this.bulkError="";try{await It(this.hass,e);let t=new Set(e.map(i=>i.id));this.selectedIds=this.selectedIds.filter(i=>!t.has(i)),this.bulkAction="",this.bulkTarget=""}catch(t){this.bulkError=E(t)}finally{this.bulkBusy=!1}}}selectedFilterCount(){return this.showFilters?Qe.reduce((e,t)=>e+this.filters[t].length,0):0}filterGroup(e,t){let i=this.filters[t].length,s=this.openFilterGroups.includes(t);return n`
                      ...
                      ${this.openToolbarPanel==="filters"?n`
                            <div class="popover-panel filter-panel">
                              <div class="filter-grid">
                                ${Qe.map(d=>this.filterGroup(r(Ci[d]),d))}
                              </div>
                              <div class="filter-footer">
                                ...
                                <ha-button
                                  appearance="plain"
                                  variant="neutral"
                                  @click=${()=>{this.filters=fe(),this.storeSessionView()}}
                                >
    ...
    `}},be=v("task-table");customElements.get(be)||customElements.define(be,Ye);var et=class extends f{static properties={tone:{reflect:!0}};static styles=b`
    :host {
      display: inline-flex;
  ...
  `;constructor(){super(),this.tone="default"}render(){return n`<span><slot></slot></span>`}},_e=v("pill");customElements.get(_e)||customElements.define(_e,et);var I=$(V),C=$(_e),ei=$(K),tt=class extends f{static properties={attachment:{attribute:!1},url:{}};static styles=b`
    :host {
      display: block;
    }
  ...
  `;hass;unsubscribeTemplate;constructor(){super(),this.attachments=[],this.users=[],this.labels=[],this.tags=[],this.history=[],this.signedFiles={},this.loading=!1,this.assignmentReady=!1,this.assignmentError="",this.attachmentError="",this.completionNotes="",this.completionError="",this.completing=!1,this.renderedDescription="",this.templateError=""}connectedCallback(){super.connectedCallback(),this.subscribeDescriptionTemplate()}disconnectedCallback(){super.disconnectedCallback(),this.disconnectDescriptionTemplate()}configure(e,t,i=[]){this.hass=e,this.task=t,this.renderedDescription=t.description||"",this.attachments=[...t.attachments],this.history=ce(t.history||[]),this.isConnected&&this.subscribeDescriptionTemplate(),this.loadDetails()}async subscribeDescriptionTemplate(){if(this.unsubscribeTemplate||!this.hass||!this.task)return;let e=this.task.description||"";if(e.trim()){this.templateError="";try{this.unsubscribeTemplate=this.hass.connection.subscribeMessage(t=>{if("error"in t){this.templateError=t.error;return}this.templateError="",this.renderedDescription=t.result},{type:"render_template",template:e,variables:{config:{type:"markdown",content:e},user:this.hass?.user?.name||""},strict:!0,report_errors:!1}),await this.unsubscribeTemplate}catch{this.renderedDescription=e,this.unsubscribeTemplate=void 0}}}disconnectDescriptionTemplate(){this.unsubscribeTemplate?.then(e=>e()).catch(()=>{}),this.unsubscribeTemplate=void 0,this.templateError=""}async loadDetails(){if(!this.hass)return;this.loading=!0,this.assignmentError="",this.attachmentError="";let[e,t]=await Promise.allSettled([B(this.hass),Lt(this.hass,this.task.id)]);e.status==="fulfilled"?(this.users=e.value.users,this.labels=e.value.labels,this.tags=e.value.tags,this.assignmentReady=!0):this.assignmentError=r("app.assignment_load_error"),t.status==="fulfilled"?this.signedFiles=t.value.signed_files||{}:this.attachmentError=r("app.attachment_load_error"),this.loading=!1}formatDate(e){if(!e)return r("app.not_scheduled");let t=new Date(e);return Number.isNaN(t.getTime())?e:new Intl.DateTimeFormat(this.hass?.locale?.language,{dateStyle:"medium",timeStyle:"short",timeZone:this.hass?.config?.time_zone}).format(t)}renderDescription(){return(this.task.description||"").trim()?n`
      ...
      ></ha-markdown>
    `:n`<p class="hint">${r("task.no_description")}.</p>`}async openAttachment(e){let t=this.signedFiles[e.id];if(!t)return;let i=document.createElement(it);i.attachment=e,i.url=t,await x({heading:e.filename,content:i,width:"large"})}async complete(){if(!this.hass||this.completing||await x({heading:r("task.complete_title"),content:n`<p>
        ${r("task.complete_confirm",{name:this.task.name})}
      </p>`,actions:[{label:r("common.cancel"),value:"cancel"},{label:r("app.complete"),value:"complete"}]})!=="complete")return!1;this.completing=!0,this.completionError="";try{return await Ft(this.hass,this.task.id,this.completionNotes),!0}catch(t){return this.completionError=E(t),!1}finally{this.completing=!1}}renderMetadata(){let e=this.users.find(s=>s.id===this.task.assignee_id)?.name,t=this.tags.find(s=>s.id===this.task.nfc_tag_id),i=(this.task.label_ids||[]).map(s=>this.labels.find(o=>o.label_id===s)).filter(s=>!!s);return g`
      <div class="pills">
        ${this.task.due?g`<${C}>
    ...
    `}scheduleText(){return he(this.task.schedule,this.hass?.locale?.language)}renderPlanning(){let e=this.task.schedule;if(e.type==="sensor"){let t=this.history.find(o=>o.type==="problem"),i=t&&t.occurred_at===this.task.due?t.message:"",s=this.task.due?O(!0):this.task.problem_warning?N():O(!1);return n`
    ...
    `:n`<p class="hint">${r("task.no_history")}.</p>`}render(){return g`
      <div class="content">
        ...
        <${I} heading=${r("task.files")}>
          ${this.renderAttachments()}
        </${I}>
        <${I} heading=${r("task.history")}>
          ${this.renderHistory()}
        </${I}>
        <${ei}
    ...
    `}},at=v("task-viewer");customElements.get(at)||customElements.define(at,st);var ti=async(a,e,t=[])=>{let i=document.createElement(at);return i.configure(a,e,t),await x({heading:e.name,content:i,actions:[{label:r("app.complete"),value:"complete",run:()=>i.complete()}]})==="complete"};var q="tasks-card",ii=$(be),si=["due","assignee"],ai=()=>({type:`custom:${q}`,show_bulk_selection:!1,show_search:!0,show_action_menu:!1,show_icon:!0,show_add_task:!0,show_header:!1,filter_assignees:[],filter_current_user:!1,filter_unassigned:!1,filter_labels:[],filter_no_labels:!1,filter_notifications:[],filter_persistent:!1,filter_no_notifications:!1,filter_triggers:[],filter_statuses:[],filter_due:[],columns:[...si]}),Di=()=>{let{type:a,...e}=ai();return e},we=(a,e,t)=>Array.isArray(a)?a.filter((i,s,o)=>typeof i=="string"&&e.some(l=>l.value===i)&&o.indexOf(i)===s):[...t],rt=a=>Array.isArray(a)?a.filter((e,t,i)=>typeof e=="string"&&i.indexOf(e)===t):[],Ii=a=>({type:a.type||`custom:${q}`,show_bulk_selection:a.show_bulk_selection===!0,show_search:a.show_search!==!1,show_action_menu:a.show_action_menu===!0,show_icon:a.show_icon!==!1,show_add_task:a.show_add_task!==!1,show_header:a.show_header===!0,filter_assignees:rt(a.filter_assignees),filter_current_user:a.filter_current_user===!0,filter_unassigned:a.filter_unassigned===!0,filter_labels:rt(a.filter_labels),filter_no_labels:a.filter_no_labels===!0,filter_notifications:rt(a.filter_notifications),filter_persistent:a.filter_persistent===!0,filter_no_notifications:a.filter_no_notifications===!0,filter_triggers:we(a.filter_triggers,ye,[]),filter_statuses:we(a.filter_statuses,$e,[]),filter_due:we(a.filter_due,ke,[]),columns:we(a.columns,ve,si)}),ot=class extends f{static properties={hass:{attribute:!1},config:{state:!0},snapshot:{state:!0},error:{state:!0}};static styles=b`
    :host {
      display: block;
      color: var(--primary-text-color);
      font-family: var(--ha-font-family-body, sans-serif);
  ...
  `;connection;unsubscribe;language;static getStubConfig(){return Di()}static getConfigForm(){return{schema:[{type:"expandable",name:"",title:r("card.options"),flatten:!0,schema:[{name:"show_bulk_selection",selector:{boolean:{}}},{name:"show_search",selector:{boolean:{}}},{name:"show_action_menu",selector:{boolean:{}}},{name:"show_icon",selector:{boolean:{}}},{name:"show_add_task",selector:{boolean:{}}},{name:"show_header",selector:{boolean:{}}}]},{type:"expandable",name:"",title:r("card.filter"),flatten:!0,schema:[{type:"expandable",name:"",title:r("task.assignment"),flatten:!0,schema:[{name:"filter_assignees",selector:{entity:{multiple:!0,filter:[{domain:"person"}]}}},{name:"filter_unassigned",selector:{boolean:{}}},{name:"filter_current_user",selector:{boolean:{}}}]},{type:"expandable",name:"",title:r("task.labels"),flatten:!0,schema:[{name:"filter_labels",selector:{label:{multiple:!0}}},{name:"filter_no_labels",selector:{boolean:{}}}]},{type:"expandable",name:"",title:r("table.notifications"),flatten:!0,schema:[{name:"filter_notifications",selector:{device:{multiple:!0,filter:[{integration:"mobile_app"}]}}},{name:"filter_persistent",selector:{boolean:{}}},{name:"filter_no_notifications",selector:{boolean:{}}}]},{type:"expandable",name:"",title:r("table.recurrence"),flatten:!0,schema:[{name:"filter_triggers",selector:{select:{multiple:!0,options:ye.map(e=>({value:e.value,label:r(e.label)}))}}}]},{type:"expandable",name:"",title:r("app.status"),flatten:!0,schema:[{name:"filter_statuses",selector:{select:{multiple:!0,options:$e.map(e=>({value:e.value,label:r(e.label)}))}}}]},{type:"expandable",name:"",title:r("task.due"),flatten:!0,schema:[{name:"filter_due",selector:{select:{multiple:!0,options:ke.map(e=>({value:e.value,label:r(e.label)}))}}}]}]},{type:"expandable",name:"",title:r("card.content"),flatten:!0,schema:[{name:"columns",selector:{select:{multiple:!0,reorder:!0,options:ve.map(e=>({value:e.value,label:r(e.label)}))}}}]}],computeLabel:e=>{let t={show_bulk_selection:"card.multi_selection",show_search:"card.search",show_action_menu:"card.action_menu",show_icon:"task.icon",show_add_task:"card.add_task",show_header:"card.table_header",filter_assignees:"task.user",filter_current_user:"card.current_user",filter_unassigned:"task.unassigned",filter_labels:"task.labels",filter_no_labels:"task.no_labels",filter_notifications:"table.notifications",filter_persistent:"task.notification_persistent",filter_no_notifications:"app.no_notifications",filter_triggers:"table.recurrence",filter_statuses:"app.status",filter_due:"card.due_periods",columns:"card.visible_columns"};return t[e.name]?r(t[e.name]):void 0}}}constructor(){super(),this.config=ai(),this.error=""}setConfig(e){if(!e||typeof e!="object")throw new Error("Card configuration is required");this.config=Ii(e)}getCardSize(){return Math.max(2,Math.min(8,this.snapshot?.tasks.length||2))}updated(){this.hass?.connection!==this.connection&&this.connect(),this.hass?.locale?.language!==this.language&&(this.language=this.hass?.locale?.language,ze(this.language))}disconnectedCallback(){this.disconnect(),super.disconnectedCallback()}disconnect(){this.unsubscribe?.(),this.unsubscribe=void 0,this.connection=void 0}async connect(){if(this.disconnect(),!this.hass)return;let e=this.hass,t=e.connection;this.connection=t,this.error="";try{let i=await St(e,s=>{this.snapshot=s});this.connection===t?this.unsubscribe=i:i()}catch(i){this.connection===t&&(this.error=E(i))}}openTask(e){this.hass&&ti(this.hass,e)}async confirmDelete(e){this.hass&&await x({heading:r("task.delete_title"),content:n`<p>
      ...
      <${ii}
        ...
        @tasks-task-add=${()=>this.hass&&void pe(this.hass)}
        @tasks-task-action=${e=>this.handleTaskAction(e.detail.action,e.detail.task)}
      ></${ii}>
    `:n`<p class="message">${r("common.loading")}</p>`}};customElements.get(q)||customElements.define(q,ot);window.customCards||=[];var Te=window.customCards.find(a=>a.type===q);Te||(Te={type:q,name:"Tasks"},window.customCards.push(Te));jt.then(()=>{Te.description=r("card.description")});
