...
_DYNAMIC_FRONTEND_KEYS = {
    ...
    "problem.sensor_available_short",
    "problem.sensor_missing",
    "problem.sensor_missing_short",
    "problem.sensor_unavailable",
    "problem.sensor_unavailable_short",
    "problem.sensor_unknown",
    "problem.sensor_unknown_short",
